...
<body>
  ...
  <main>
    <br><br>
      <div class="row center"><br><br><br>
        <br><b>EL JEFE DEL DEPARTAMENTO DE PERMISOS Y LICENCIAS PARA CONSTRUCCIÓN </b> <br><br>
        <b> C E R T I F I C A </b> <br><br>
      </div><br>
    <div class="row justify">
      Que el predio ubicado en calle <b>{{ $license->property->calle }}</b><br><br>
      Número: <b>{{ $license->property->no }}</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sección: <b>N/A</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Manzana: <b>{{ $license->property->manzana }}</b>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Lote: <b>{{ $license->property->lote }}</b> <br><br>
      Colonia o fraccionamiento: <b>{{ $license->property->colonia }}</b> <br><br>
      De esta Ciudad, propiedad del C: <b>{{ $license->owner->nombre_apellidos }}</b> <br><br>
      Está correctamente alineado de acuedo con el plano de la población, no teniendo
      conocimiento esta oficina a mi cargo, de proyecto de ampliación en la mencionado calle,
      así mismo, se hace constar que el número arriba indicado es que oficialmente le corresponde.
      <br>
    </div>
    <br>
    <div class="row justify">
      Se extiende la Presente en la Ciudad de Zacatecas, Zac. A petición del interesado para los usos y fines que al mismo convenga.
    </div>
    <br>
