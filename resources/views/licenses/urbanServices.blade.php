...
<body>
  ...
  <main>
    <br><br><br><br><br>
    <div class="row right">
      ASUNTO: <b>CONSTANCIA DE URBANIZACIÓN</b> <br>
    </div><br>
    <br>
    <div class="row center">
      <b>EL JEFE DEL DEPARTAMENTO DE PERMISOS Y LICENCIAS PARA CONSTRUCCIÓN </b> <br><br><br><br>
      <b> HACE CONSTAR </b> <br><br>
    </div><br>
    <div class="row justify">
      Que en la visita de inspección realizada por el personal ténico de esta Secretaria,
      al predio ubicado en <b>CALLE {{ $license->property->calle }} {{ $license->property->no }}</b>, COLONIA O FRACCIONAMIENTO: <b>{{ $license->property->colonia }}</b>
      en esta ciudad, propiedad de <b>C. {{ $license->owner->nombre_apellidos }},</b> se encuentra urbanizado y se constató la existencia de
      los servicios públicos básicos:
        @if ($license->property->agua == true && $license->property->luz == true && $license->property->drenaje == true)
            agua, luz y drenaje
        @elseif ($license->property->agua == true && $license->property->luz == true)
            agua y luz
        @elseif ($license->property->agua == true && $license->property->drenaje == true)
            agua y drenaje
        @elseif ($license->property->luz == true && $license->property->drenaje == true)
            luz y drenaje
        @elseif ($license->property->agua == true)
            agua
        @elseif ($license->property->luz == true)
            luz
        @elseif ($license->property->drenaje == true)
            drenaje
        @else
    ...
    <div class="row justify">
      ...
      en la Ciudad de Zacatecas, Capital del Estado del mismo nombre a los a los {{ $validity->dayDesc }} días del mes de
